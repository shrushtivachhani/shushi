								...
								<div class="col-lg-12">
									<div class="group-feed">
										<div class="group-avatar">
											...
											<figure class="group-dp"><img src="images/resources/user.jpg" alt="">
											</figure>
										</div>
										<div class="grp-info about">
											...
											<ul class="nav nav-tabs about-btn">
												...
												<li class="nav-item"><a class="" href="#pictures"
														data-toggle="tab">Pictures</a></li>
												...
												<li>
													<div class="more">
														<div class="more-post-optns">
															<i class="">
																<svg class="feather feather-more-horizontal"
											...
											<div class="grp-about">
												<div class="row">
													<div class="col-lg-8 col-md-6">
														<h4>About Me!</h4>
														<p>Hi! My name is Georg Peeter but some people may know me as
															peeter! I have a Twitch channel where I stream, play and
															review all the newest games.</p>
														<ul class="badges">
												...
												<div class="tab-content">
																		...
																		<ul class="upload-media">
																			...
																			<li>
																				<a href="live-stream.html" title="">
																					<i><img src="images/live-stream.png"
																							alt=""></i>
																	...
																	<div class="user-post">
																		<div class="friend-info">
																			...
																			<div class="friend-name">
																					...
																					<div class="more-post-optns">
																						...
																						<ul>
																							...
																							<li>
																								...
																								Post
																								<span>If inappropriate
																									Post By
																									Mistake</span>
																							</li>
																							<li>
																								<i
																									class="icofont-flag"></i>Report
																								<span>Inappropriate
																									content</span>
																							</li>
																						</ul>
																				...
																				<ins><a title=""
																						href="time-line.html">Jack
																						Carter</a> Share Post</ins>
																				<span><i class="icofont-globe"></i>
																					published: Sep,15 2020</span>
																			</div>
																			<div class="post-meta">
																				<a href="post-detail.html"
																					class="post-title">Supervision as a
																				...
																				<div class="stat-tools">
																					<div class="box">
																						<div class="Like"><a
																							...
																							<div class="Emojis">
																								...
																								<div
																									class="Emoji Emoji--haha">
																									<div
																										class="icon icon--haha">
																									</div>
																								</div>
																								<div
																					...
																					<a title="" href="#"
																						class="comment-to"><i
																							class="icofont-comment"></i>
																						Comment</a>
																					<a title="" href="#"
																						class="share-to"><i
																							class="icofont-share-alt"></i>
																						Share</a>
																	...
																	<div class="user-post">
																		<div class="friend-info">
																			...
																			<div class="friend-name">
																				...
																				<ins><a title=""
																						href="time-line.html">Georg
																						Peeter </a> Create Post</ins>
																				<span><i class="icofont-globe"></i>
																					published: Sep,15 2020</span>
																			</div>
																			<div class="post-meta">
																				<figure>
																					<a data-toggle="modal"
																						...
																						<img src="images/resources/study.jpg"
																							alt="">
																					</a>
																				</figure>
																				<a href="post-detail.html"
																		...
																		<div class="friend-info">
																			...
																			<div class="post-meta">
																				...
																				<figure>
																					...
																					<img src="images/resources/laptop.png"
																						alt="">
																				</figure>
																				<a href="https://themeforest.net/item/winku-social-network-toolkit-responsive-template/22363538"
																					class="post-title"
																					target="_blank">Winku Social Network
																					with Company Pages Theme</a>
																				<p>
																					“Winku” is a social community mobile
																					app kit with features. user can use
																					this app for sharing blog, posts,
																					timeline, create Group, Create
																					Pages, chat/Messages, Movies
																					sharing, QA, and Much More.
																				</p>
																				<div class="we-video-info">
																					<ul>
																						<li>
																...
																<div class="main-wraper">
																	<div class="user-post">
																		<div class="friend-info">
																			...
																			<div class="post-meta">
																				<em><a href="https://www.youtube.com/embed/zdow47FQRfQ"
																						title=""
																				...
																				<p>
																					Cookie? Biscuit? Bikkie? They all
																					mean the same thing! Our lovely
																					English teachers will quickly show
																					you some pronunciation and
																					vocabulary differences from
															...
															<div class="col-lg-4">
																<aside class="sidebar static left">
																	<div class="advertisment-box">
																		<h4 class=""><i class="icofont-info-circle"></i>
																			advertisment</h4>
																		<figure>
																	...
																	<div class="widget">
																		...
																		<div class="recent-media">
																			<figure>
																				<img src="images/resources/user-video7.jpg"
																					alt="">
																				<a class="play-btn" data-fancybox=""
																					href="https://www.youtube.com/embed/vP-l9L3Ku5Y"><i
																						class="icofont-play"></i></a>
																				<span>Pool Party 2020</span>
																			</figure>
																			<figure>
																				<img src="images/resources/user-video10.jpg"
																					alt="">
																				<a class="play-btn" data-fancybox=""
																					href="https://www.youtube.com/embed/vP-l9L3Ku5Y"><i
																						class="icofont-play"></i></a>
																	...
																	<div class="widget stick-widget">
																		<h4 class="widget-title">You May Like Groups
																		</h4>
																		<ul class="suggestd">
																			<li>
																				<a class="sug-pic" href="#"
																					title=""><img
																						src="images/resources/sug-page-1.jpg"
																						alt=""></a>
																				<a class="sug-title" href="#"
																					title="">Physics Shop</a>
																				<button class="sug-like"><i
																						class="icofont-like"></i><i
																						class="icofont-check-alt"></i></button>
																			</li>
																			<li>
																				<a class="sug-pic" href="#"
														...
														<div class="row merged-10">
															<div class="col-lg-3 col-md-4 col-sm-6">
																<div class="uzr-pictures">
																	<a href="#" data-target="#img-comt"
																		data-toggle="modal">
																		<img alt=""
																			src="images/resources/user-pic1.jpg">
																	</a>
																	<ul class="hover-action">
																		<li><a href="#" title=""><i
																					class="icofont-like"></i> 3</a></li>
																		<li><a href="#" title=""><i
																					class="icofont-chat"></i> 5</a></li>
																	</ul>
																</div>
															</div>
															<div class="col-lg-3 col-md-4 col-sm-6">
																<div class="uzr-pictures">
																	<a href="#" data-target="#img-comt"
																		data-toggle="modal">
																		<img alt=""
																			src="images/resources/user-pic2.jpg">
																	</a>
																	<ul class="hover-action">
																		<li><a href="#" title=""><i
																					class="icofont-like"></i> 3</a></li>
															...
															<div class="col-lg-3 col-md-4 col-sm-6">
																<div class="uzr-pictures">
																	<a href="#" data-target="#img-comt"
																		data-toggle="modal">
																		<img alt=""
																			src="images/resources/user-pic3.jpg">
																	</a>
																	<ul class="hover-action">
																		<li><a href="#" title=""><i
																					class="icofont-like"></i> 3</a></li>
															...
															<div class="col-lg-3 col-md-4 col-sm-6">
																<div class="uzr-pictures">
																	<a href="#" data-target="#img-comt"
																		data-toggle="modal">
																		<img alt=""
																			src="images/resources/user-pic4.jpg">
																	</a>
																	<ul class="hover-action">
																		<li><a href="#" title=""><i
																					class="icofont-like"></i> 3</a></li>
															...
															<div class="col-lg-3 col-md-4 col-sm-6">
																<div class="uzr-pictures">
																	<a href="#" data-target="#img-comt"
																		data-toggle="modal">
																		<img alt=""
																			src="images/resources/user-pic5.jpg">
																	</a>
																	<ul class="hover-action">
																		<li><a href="#" title=""><i
																					class="icofont-like"></i> 3</a></li>
															...
															<div class="col-lg-3 col-md-4 col-sm-6">
																<div class="uzr-pictures">
																	<a href="#" data-target="#img-comt"
																		data-toggle="modal">
																		<img alt=""
																			src="images/resources/user-pic6.jpg">
																	</a>
																	<ul class="hover-action">
																		<li><a href="#" title=""><i
																					class="icofont-like"></i> 3</a></li>
															...
															<div class="col-lg-3 col-md-4 col-sm-6">
																<div class="uzr-pictures">
																	<a href="#" data-target="#img-comt"
																		data-toggle="modal">
																		<img alt=""
																			src="images/resources/user-pic7.jpg">
																	</a>
																	<ul class="hover-action">
																		<li><a href="#" title=""><i
																					class="icofont-like"></i> 3</a></li>
															...
															<div class="col-lg-3 col-md-4 col-sm-6">
																<div class="uzr-pictures">
																	<a href="#" data-target="#img-comt"
																		data-toggle="modal">
																		<img alt=""
																			src="images/resources/user-pic8.jpg">
																	</a>
																	<ul class="hover-action">
																		<li><a href="#" title=""><i
																					class="icofont-like"></i> 3</a></li>
															...
															<div class="col-lg-3 col-md-4 col-sm-6">
																<div class="uzr-pictures">
																	<a href="#" data-target="#img-comt"
																		data-toggle="modal">
																		<img alt=""
																			src="images/resources/user-pic9.jpg">
																	</a>
																	<ul class="hover-action">
																		<li><a href="#" title=""><i
																					class="icofont-like"></i> 3</a></li>
															...
															<div class="col-lg-3 col-md-4 col-sm-6">
																<div class="uzr-pictures">
																	<a href="#" data-target="#img-comt"
																		data-toggle="modal">
																		<img alt=""
																			src="images/resources/user-pic10.jpg">
																	</a>
																	<ul class="hover-action">
																		<li><a href="#" title=""><i
																					class="icofont-like"></i> 3</a></li>
															...
															<div class="col-lg-3 col-md-4 col-sm-6">
																<div class="uzr-pictures">
																	<a href="#" data-target="#img-comt"
																		data-toggle="modal">
																		<img alt=""
																			src="images/resources/user-pic11.jpg">
																	</a>
																	<ul class="hover-action">
																		<li><a href="#" title=""><i
																					class="icofont-like"></i> 3</a></li>
															...
															<div class="col-lg-3 col-md-4 col-sm-6">
																<div class="uzr-pictures">
																	<a href="#" data-target="#img-comt"
																		data-toggle="modal">
																		<img alt=""
																			src="images/resources/user-pic12.jpg">
																	</a>
																	<ul class="hover-action">
																		<li><a href="#" title=""><i
																					class="icofont-like"></i> 3</a></li>
															...
															<div class="col-lg-3 col-md-4 col-sm-6">
																<div class="uzr-pictures">
																	<a href="#" data-target="#img-comt"
																		data-toggle="modal">
																		<img alt=""
																			src="images/resources/user-pic13.jpg">
																	</a>
																	<ul class="hover-action">
																		<li><a href="#" title=""><i
																					class="icofont-like"></i> 3</a></li>
															...
															<div class="col-lg-3 col-md-4 col-sm-6">
																<div class="uzr-pictures">
																	<a href="#" data-target="#img-comt"
																		data-toggle="modal">
																		<img alt=""
																			src="images/resources/user-pic14.jpg">
																	</a>
																	<ul class="hover-action">
																		<li><a href="#" title=""><i
																					class="icofont-like"></i> 3</a></li>
															...
															<div class="col-lg-3 col-md-4 col-sm-6">
																<div class="uzr-pictures">
																	<a href="#" data-target="#img-comt"
																		data-toggle="modal">
																		<img alt=""
																			src="images/resources/user-pic15.jpg">
																	</a>
																	<ul class="hover-action">
																		<li><a href="#" title=""><i
																					class="icofont-like"></i> 3</a></li>
														...
														<div class="row merged-10">
															<div class="col-lg-4 col-md-4 col-sm-6">
																<div class="user-video">
																	<figure>
																		<img alt=""
																			src="images/resources/user-video1.jpg">
																		<a href="https://www.youtube.com/embed/vP-l9L3Ku5Y"
																			data-fancybox="" class="play-btn"><i
																				class="icofont-play"></i></a>
																	</figure>
															...
															<div class="col-lg-4 col-md-4 col-sm-6">
																<div class="user-video">
																	<figure>
																		<img alt=""
																			src="images/resources/user-video2.jpg">
																		<a href="https://www.youtube.com/embed/vP-l9L3Ku5Y"
																			data-fancybox="" class="play-btn"><i
																				class="icofont-play"></i></a>
																	</figure>
															...
															<div class="col-lg-4 col-md-4 col-sm-6">
																<div class="user-video">
																	<figure>
																		<img alt=""
																			src="images/resources/user-video3.jpg">
																		<a href="https://www.youtube.com/embed/vP-l9L3Ku5Y"
																			data-fancybox="" class="play-btn"><i
																				class="icofont-play"></i></a>
																	</figure>
															...
															<div class="col-lg-4 col-md-4 col-sm-6">
																<div class="user-video">
																	<figure>
																		<img alt=""
																			src="images/resources/user-video4.jpg">
																		<a href="https://www.youtube.com/embed/vP-l9L3Ku5Y"
																			data-fancybox="" class="play-btn"><i
																				class="icofont-play"></i></a>
																	</figure>
															...
															<div class="col-lg-4 col-md-4 col-sm-6">
																<div class="user-video">
																	<figure>
																		<img alt=""
																			src="images/resources/user-video5.jpg">
																		<a href="https://www.youtube.com/embed/vP-l9L3Ku5Y"
																			data-fancybox="" class="play-btn"><i
																				class="icofont-play"></i></a>
																	</figure>
															...
															<div class="col-lg-4 col-md-4 col-sm-6">
																<div class="user-video">
																	<figure>
																		<img alt=""
																			src="images/resources/user-video6.jpg">
																		<a href="https://www.youtube.com/embed/vP-l9L3Ku5Y"
																			data-fancybox="" class="play-btn"><i
																				class="icofont-play"></i></a>
																	</figure>
															...
															<div class="col-lg-4 col-md-4 col-sm-6">
																<div class="user-video">
																	<figure>
																		<img alt=""
																			src="images/resources/user-video7.jpg">
																		<a href="https://www.youtube.com/embed/vP-l9L3Ku5Y"
																			data-fancybox="" class="play-btn"><i
																				class="icofont-play"></i></a>
																	</figure>
															...
															<div class="col-lg-4 col-md-4 col-sm-6">
																<div class="user-video">
																	<figure>
																		<img alt=""
																			src="images/resources/user-video8.jpg">
																		<a href="https://www.youtube.com/embed/vP-l9L3Ku5Y"
																			data-fancybox="" class="play-btn"><i
																				class="icofont-play"></i></a>
																	</figure>
															...
															<div class="col-lg-4 col-md-4 col-sm-6">
																<div class="user-video">
																	<figure>
																		<img alt=""
																			src="images/resources/user-video9.jpg">
																		<a href="https://www.youtube.com/embed/vP-l9L3Ku5Y"
																			data-fancybox="" class="play-btn"><i
																				class="icofont-play"></i></a>
																	</figure>
															...
															<div class="col-lg-4 col-md-4 col-sm-6">
																<div class="user-video">
																	<figure>
																		<img alt=""
																			src="images/resources/user-video10.jpg">
																		<a href="https://www.youtube.com/embed/vP-l9L3Ku5Y"
																			data-fancybox="" class="play-btn"><i
																				class="icofont-play"></i></a>
																	</figure>
															...
															<div class="col-lg-4 col-md-4 col-sm-6">
																<div class="user-video">
																	<figure>
																		<img alt=""
																			src="images/resources/user-video11.jpg">
																		<a href="https://www.youtube.com/embed/vP-l9L3Ku5Y"
																			data-fancybox="" class="play-btn"><i
																				class="icofont-play"></i></a>
																	</figure>
															...
															<div class="col-lg-4 col-md-4 col-sm-6">
																<div class="user-video">
																	<figure>
																		...
																		<img alt=""
																			src="images/resources/user-video12.jpg">
																		<a href="https://www.youtube.com/embed/vP-l9L3Ku5Y"
																			data-fancybox="" class="play-btn"><i
																				class="icofont-play"></i></a>
																	</figure>
													...
													<div class="tab-pane fade" id="friends">
														...
														<div class="row merged-10 col-xs-6">
															<div class="col-lg-3 col-md-4 col-sm-6">
																<div class="friendz">
																	<figure><img src="images/resources/speak-10.jpg"
																			alt=""></figure>
															...
															<div class="col-lg-3 col-md-4 col-sm-6">
																<div class="friendz">
																	<figure><img src="images/resources/speak-11.jpg"
																			alt=""></figure>
															...
															<div class="col-lg-3 col-md-4 col-sm-6">
																<div class="friendz">
																	<figure><img src="images/resources/speak-12.jpg"
																			alt=""></figure>
															...
															<div class="col-lg-3 col-md-4 col-sm-6">
																<div class="friendz">
																	<figure><img src="images/resources/speak-4.jpg"
																			alt=""></figure>
															...
															<div class="col-lg-3 col-md-4 col-sm-6">
																<div class="friendz">
																	<figure><img src="images/resources/speak-1.jpg"
																			alt=""></figure>
																	<span><a href="#" title="">Amy watson</a></span>
																	<ins>Oxford University, UK</ins>
																	<a href="#" title="" data-ripple=""><i
															...
															<div class="col-lg-3 col-md-4 col-sm-6">
																<div class="friendz">
																	<figure><img src="images/resources/speak-2.jpg"
																			alt=""></figure>
															...
															<div class="col-lg-3 col-md-4 col-sm-6">
																<div class="friendz">
																	<figure><img src="images/resources/speak-5.jpg"
																			alt=""></figure>
																	<span><a href="#" title="">Amy Watson</a></span>
																	<ins>Bz University, Pakistan</ins>
																	<a href="#" title="" data-ripple=""><i
															...
															<div class="col-lg-3 col-md-4 col-sm-6">
																<div class="friendz">
																	<figure><img src="images/resources/speak-7.jpg"
																			alt=""></figure>
																	<span><a href="#" title="">Muhammad Khan</a></span>
																	<ins>Oxford University, UK</ins>
																	<a href="#" title="" data-ripple=""><i
													...
													<div class="tab-pane fade" id="about">
														<div class="row merged20">
															<div class="col-lg-8">
																<div class="main-wraper">
																	...
																	<div class="info-block-list">
																		<ul>
																			<li>Date of Birth: <span>Dec, 17 1980</span>
																			</li>
																			<li>Location: <span>Los Angeles,
																					California</span></li>
																			<li>Web: <span>www.sample.com</span></li>
																			<li>Email:
																				<span>sample123@yourmail.com</span></li>
																			<li>Location: <span>Los Angeles,
																					California</span></li>
																	...
																	<div class="info-block-list">
																		<div class="info-block">
																			...
																			<p>Breaking Good, RedDevil, People of
																				...
																				American Guy, The Last Windbender, Game
																				of Wars.</p>
																		</div>
																		<div class="info-block">
																			<h6>Favourite Music Bands / Artists</h6>
																			<p>Iron Maid, DC/AC, Megablow, Kung
																		...
																		<div class="info-block">
																			...
																			<p>The Revengers Saga, The Scarred Wizard
																				and the Fire Crown, Crime Squad, Metal
																				Man, The Dark Rider, Watchers, The
																				Impossible Heist.</p>
																		</div>
																		<div class="info-block">
																			<h6>Favourite Books</h6>
																			<p>The Crime of the Century, Egiptian
																				Mythology 101, The Scarred Wizard, Lord
																				of the Wings, Amongst Gods, The Oracle,
																				A Tale of Air and Water.</p>
																		</div>
																		<div class="info-block">
																			<h6>Favourite Games</h6>
																			<p>The First of Us, Assassin’s Squad, Dark
															...
															<div class="col-lg-4">
																<aside class="sidebar">
																	<div class="widget">
																		<h4 class="widget-title">Complete Your Profile
																		</h4>
																		<span>Complete your profile by filling profile
																			info fields, completing quests & unlocking
																			badges</span>
																		...
																		<ul class="prof-complete">
																			<li><i class="icofont-plus-square"></i> <a
																					href="#" title="">Upload Your
																					Picture</a><em>10%</em></li>
																			<li><i class="icofont-plus-square"></i> <a
																					href="#" title="">Your
																					University?</a><em>20%</em></li>
																			<li><i class="icofont-plus-square"></i> <a
																					href="#" title="">Invite to 10+
																					members</a><em>20%</em></li>
																		</ul>
																	</div><!-- complete profile widget -->
																	<div class="widget">
																		<h4 class="widget-title">User stats</h4>
																		<ul class="user-stat">
																			<li><i class="icofont-lollipop"></i><span>Last
																					Post <em>2 hours ago</em></span>
																			</li>
																			<li><i class="icofont-spotify"></i><span>Last
																					comment <em>6 hours ago</em></span>
																			</li>
																			<li><i class="icofont-like"></i><span>Most
																					Liked Post<em>540 Likes</em></span>
																			</li>
																			<li><i class="icofont-user-alt-4"></i><span>Last
																					Friend Added <em>2 days
																						ago</em></span></li>
																		</ul>
																	</div><!-- complete profile widget -->
																</aside>
